<template>
	<div class="container-xl pb-5" v-if="locale">
								...
								<div class="col-md-10">
									<b-tabs v-model="tabIndex" content-class="pt-3 pb-3 align-items-center"
										...
										<b-tab title="معلومات الجهة">
											...
											>
												<b-card-body class="p-0">
													<Base64 ref="localeCover" image-classes="rounded" image-style="max-height:230px;"
													        :imageSrc="locale.cover ? locale.cover : 'https://dummyimage.com/600x210/eff0f2/.gif'"
													        @change="setImage($event, 'requestedCover')"></base64>
												</b-card-body>
												<b-card-body class="pt-0">
													<b-media class="position-relative">
														<template v-slot:aside>
															<div class="aside">
																<Base64 ref="localeAvatar" image-classes="rounded-circle border-white avatar"
																        style="position: absolute;top: -30px;border: 5px solid;width: 107px;height: 107px;"
																        class="rounded-circle border-white"
																        :imageSrc="locale.avatar ? locale.avatar : 'https://dummyimage.com/100x100/eff0f2/.gif'"
																        @change="setImage($event, 'requestedAvatar')"></base64>
															</div>
														</template>
													</b-media>
												</b-card-body>
											...
											<div class="w-25 mt-3 mx-auto">
												<b-button @click="save()" type="submit" rounded block variant="success">تعديل</b-button>
												<b-button @click="tabIndex--" class="text-muted" block rounded variant="link">السابق</b-button>
											</div>
										</b-tab>
									</b-tabs>
        ...
        methods: {
            ...
            async save() {
                await this.$axios.$request({
                    url: '/locales/' + this.$route.params.username,
                    method: 'PUT',
                    data: {
